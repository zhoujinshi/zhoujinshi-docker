...
-d zhoujinshi/java8-mvn3 java -jar /app.jar --server.port=8761 \
...
-d zhoujinshi/java8-mvn3 java -jar /app.jar --server.port=8762 \
...
-v `pwd`/logs:/var/logs/java/ -v maven-repo:/root/.m2 -p 8762:8762 --expose=8762 \
-d zhoujinshi/java8-mvn3 java -jar /app.jar --server.port=8762 \
--link=cnbbx-center:zhoujinshi/java8-mvn3 --link=cnbbx-center2:zhoujinshi/java8-mvn3 \
...
-d zhoujinshi/java8-mvn3 java -jar /app.jar --server.port=8763 \
--link=cnbbx-center:zhoujinshi/java8-mvn3 --link=cnbbx-center2:zhoujinshi/java8-mvn3 \
--eureka.client.serviceUrl.defaultZone=$HOST_ZONE
...
-d zhoujinshi/java8-mvn3 java -jar /app.jar --server.port=8080 \
--link=cnbbx-center:zhoujinshi/java8-mvn3 --link=cnbbx-center2:zhoujinshi/java8-mvn3 \
--eureka.client.serviceUrl.defaultZone=$HOST_ZONE
~~~
### 重用Maven本地存储库
...
docker run --rm -it -v maven-repo:/root/.m2 zhoujinshi/java8-mvn3 mvn archetype:generate # will download artifacts
~~~
### 其他参数
~~~
