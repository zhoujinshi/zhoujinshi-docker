...
<xsl:template match="/">
    <html>
        ...
        <body>
            ...
            <hr/>
            Generated by <a href='#'>nginx-http-flv-module</a>&#160;<xsl:value-of select="/http-flv/nginx_http_flv_version"/>,
            <a href="#">webServer</a>&#160;<xsl:value-of select="/http-flv/nginx_version"/>,
